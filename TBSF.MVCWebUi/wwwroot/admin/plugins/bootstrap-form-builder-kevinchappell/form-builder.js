            ...
            BootstrapDialog.show({
                ...
                onshown: function (dialogRef) {
                    ...
                    $('#tt_tree_machine_prop').tree({
                        url: 'https://proxy.sorubankasi.com/SlimProxyBoot.php?url=pkFillMachineToolFullProperties_sysMachineToolProperties&pk=' + $('#pk').val() + '',
            ...
            BootstrapDialog.show({
                ...
                onshown: function (dialogRef) {
                    ...
                    $('#tt_tree_machine_unit_prop').tree({
                        url: 'https://proxy.sorubankasi.com/SlimProxyBoot.php?url=pkFillUnitsTree_sysUnits&pk=' + $('#pk').val() + '',
                        queryParams: {url: 'pkFillMachineToolFullProperties_sysMachineToolProperties',
                            pk: $('#pk').val(),
                        },
                        method: 'get',
